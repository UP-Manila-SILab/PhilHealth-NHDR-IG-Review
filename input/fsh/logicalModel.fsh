...
Title: "Minimum Required Patient Data"
Description: "Sample Logical Model"
* PhilHealthID 1..1 Identifier "PhilHealth Identification Number"
* name 0..* BackboneElement "Test Name"
* name.familyName 1..1 string "Surname"
* name.firstName 0..1 string "First Name"
* name.middleName 0..1 string "Middle Name"
* sex 0..1 CodeableConcept "Sex at Birth"
...
// * birth.multiple 0..1 positiveInt "Number of siblings + person in case of multiple birth"
...
// * telecom 0..1 ContactPoint "Means of contact"
// * contact 0..* Identifier "Identifiers of contact persons"
// * communication 0..1 CodeableConcept "language of communication"
// * generalPractitioner 0..1 Identifier "identifier of the GMD holder"
// * managingOrganisation 0..1 Identifier "identifier of the organisation managing the patient record"
